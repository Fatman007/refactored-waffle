        ...
        <>
            ...
            <FrontendApp settings={props.settings} menuitems={props.menuitems} hero={props.hero} footer_first_menuitems={props.footer_first_menuitems} footer_second_menuitems={props.footer_second_menuitems} footer_third_menuitems={props.footer_third_menuitems} footer_four_menuitems={props.footer_four_menuitems}>
                    ...
                    <div className="text-left container mx-auto relative">
                        ...
                        <div className=" flex sm:flex xs:block items-center sm:justify-between xs:justify-center">
                            <div className=" sm:text-left xs:text-center">
                                <h2 className=" 2xl:text-5xl xl:text-5xl lg:text-5xl md:text-5xl sm:text-5xl xs:text-4xl font-bold text-white">{props.page.name}</h2>
                                <nav className="flex sm:justify-start xs:justify-center py-3 text-gray-700 rounded-lg" aria-label="Breadcrumb">
                                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-1 text-lg font-normal text-slate-400 md:ml-2">{props.page.name}</span>
                                        </div>
                                        </li>
                                    </ol>
                                </nav>
                ...
                <div className="container mx-auto text-slate-300">
                    <p className="mt-5 font-light text-xl leading-normal py-2 mb-4">{JSON.parse(props.page.pagemeta.value).short_content}</p>
                    <div className="mt-5 font-light text-xl leading-normal py-2 mb-4 whitespace-pre-line">
                        {JSON.parse(props.page.pagemeta.value).description}
                    </div>
                </div>
                {/* page area end */}
            </FrontendApp>
